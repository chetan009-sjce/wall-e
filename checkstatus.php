...
<! form status>
<div class="col-sm-6 mt-5 mx-3"><form action="" method="POST" class="form-inline"><div class="form-group mr-3 d-print-none">
<label for="checkid" class="font-weight-bold pl-2">Enter Request ID: </label>
...
if(isset($_REQUEST['checkid'])){
    if($_REQUEST['checkid']==""){
       $k= '<div class="alert alert-warning mt-4">Fill the Id</div>';}
       else{
...
<div class="text-center">
    <form action="" class="mb-3 d-print-none"><input class="btn btn-danger" type="submit" value="Print" onClick="window.print()">
    <input class="btn btn-secondary" type="submit" value="Close">


</form>
</div>
<?php }else{  $msg='<div class="alert alert-info mt-4">Your Request is Still Pending</div>';}} }?>
