...
if(isset($_REQUEST['rSignup'])){
    if($_REQUEST['rName']=="" || $_REQUEST['rEmail']=="" || $_REQUEST['rPassword']==""){
        ...
        if($reult->num_rows==1){
          $regmsg=  '<div class="alert alert-warning mt-2" role="alert">Email ID Already Registered!!<br>Use Other Email ID</div>';
        } else{
...
if($conn->query($sql)==TRUE){
   ...
   echo "<script>location.href='index/userRegistration.php'</script>";
}
} }}
?>
 ...
 <h2 class="text-center">Create an Account</h2>
    <div class="row mt-4 mb-4">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <i class="fas fa-user"></i> <label for="pass"
            ...
            Data policy and cookie policy</em><br>
